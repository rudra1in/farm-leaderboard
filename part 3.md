**Part 3 of 7 – FastAPI Routes + main.py + Rate Limiting**
...
### How to run the Backend (for later)
...
Reply with **`next`** or **`part 4`** to receive the **Kafka Consumer** (the part that actually updates Redis, PostgreSQL, and MongoDB).